...
public abstract class PriorityQueue<T> {
     ...
     * object which will be used by the {@link com.doogga.cache.PriorityQueue#PriorityQueue(int,boolean)}
     ...
     * the {@link com.doogga.cache.PriorityQueue#PriorityQueue(int,boolean)} constructor
